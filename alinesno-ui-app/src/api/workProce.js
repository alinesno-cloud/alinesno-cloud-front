...
export function getYsList(data) {
	return request.get("/api/security/quality/acceptRecordAccount", data);
}

/**
 * 获取预警台账1
 */
export function getWarnAccount(data) {
	return request.get("/api/security/quality/warnAccount", data);
}

/**
 * 获取罚款台账1
 */
export function getFkAccount(data) {
	return request.get("/api/security/quality/punishesAccount", data);
}
 ...
 * 获取我的收藏-检查任务1
 */
export function getCollectRW(data) {
	return request.get("/api/security/myWork/quality/checkTaskCollect", data);
}

/**
 * 获取我的收藏-检查工作1
 */
export function getCollectGZ(data) {
	return request.get("/api/security/myWork/quality/checkCollect", data);
}

/**
 * 获取我的收藏-验收工作1
 */
export function getCollectYS(data) {
	return request.get("/api/security/myWork/quality/acceptCollect", data);
}
...
export function getJcrwDetailJilu(data) {
	return request.get("/api/security/quality/checkRecordsAccount", data);
}
 ...
 * 获取验收记录的详情1
 */
export function getYsjlDetail(data) {
 ...
 * 获取罚款台账的详情1
 */
export function getFkDetail(data) {
	return request.get("/api/security/quality/punishesDetail", data);
}

/**
 * 检查指派任务1 
 */
export function zhipaiJc(data){
 ...
 *  获取工序报验首页数据统计
 */
export function getWorkProceIndex(data) {
	return request.get("/api/security/quality/statistics", data);
}
