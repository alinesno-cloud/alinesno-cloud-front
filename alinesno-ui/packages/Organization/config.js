...
import { GET_DEPT_ROOT, GET_DEPT_TREE, GET_USER_BY_DEPT, GET_PAGE_EMPLOYEE } from '../../src/api/organization.js'
...
async function loadDepOrUser ( node, loadDep = true ) {
  ...
  if ( node.level === 0 ) { // 根目录
    ...
    nodeData = ( await GET_PAGE_EMPLOYEE( {deptId:node.data.deptId} ) ).data  // 获取部门下人员
  }
